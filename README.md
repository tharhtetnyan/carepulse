...
### [⬇️ Download APK (v1.0)](https://github.com/tharhtetnyan31/carepulse/releases/download/v1.1/carepulse.apk)
...
| Permission | Reason |
|---|---|
| POST_NOTIFICATIONS | Medication reminder alerts |
| CALL_PHONE | Emergency one-tap calling |
| SEND_SMS | SOS message to emergency contacts |
| RECEIVE_BOOT_COMPLETED | Restore reminders after device reboot |
| FOREGROUND_SERVICE | Reliable background reminder delivery |
